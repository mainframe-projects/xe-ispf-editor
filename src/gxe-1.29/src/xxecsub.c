...
//************************************                             //~varcI~
	UTRACEP("usetresizehint2 w=%d,h=%d,col=%d,row=%d\n",Pscrwidth,Pscrheight,Pmaxcol,Pmaxrow);//~varcI~
    if (Gxxestat & GXXES_NOGEOMETRYHINT)	//no set geometry hint //~varcI~
    {                                                              //~varcI~
    ...
    {//check resize                                                //~varcI~
		UTRACEP("usetresizehint2 not RESIZE ON ONSIZE option min=%d,scr=%d\n",Sminx,Pscrwidth);//~varcR~
...
//************************************                             //~var8R~
    ...
    dprintf("csub_copy_gc src=%p,tgt=%p,linewidth=%f,cairo_patern_type=%d\n",Ppgcsource,Ppgc,linewidth,cairo_pattern_get_type(pattern));//~var8R~
...
//************************************                             //~var8R~
	...
	csub_draw_line(Ppgc,linewidth,Px1,Py1,Px2,Py2);                //~var8R~
    dprintf("csub_gdk_draw_line_direct stroke linewidth=%f\n",cairo_get_line_width(Ppgc));//~var8R~
}//csub_gdk_draw_line                                              //~var8R~
#endif                                                             //~vbi9R~
...
{                                                                  //~var8R~
	PangoAttrList  *plist;                                         //~var8R~
//**************                                                   //~var8R~
	UTRACEP("csub_layout_set_textcolor before\n");                 //~var8R~
...
#endif                                                             //~var8R~
    UTRACEP("before csub_gdk_draw_layout\n");                      //~var8R~
//  UTRACELAYOUT(Pplayout);                                        //~var8R~
    cairo_move_to(Ppgc,Pxx,Pyy);                                   //~var8R~
    pango_cairo_show_layout(Ppgc,Pplayout);                        //~var8R~
    UTRACEP("after csub_gdk_draw_layout\n");                       //~var8R~
//  UTRACELAYOUT(Pplayout);                                        //~var8R~
//	dprintf("csub_gdk_draw_layout pixmap=%p,ref=%d\n",Pppixmap,cairo_surface_get_reference_count(Pppixmap));//~var8R~
